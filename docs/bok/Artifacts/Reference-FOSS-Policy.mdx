...
authors:
  - name: Citi
  - url: https://github.com/Citi/citi-ospo
...
This document orginates from the [Citi `citi-ospo` repository on GitHub](https://github.com/Citi/citi-ospo/blob/main/FOSS%20Contribution%20Guidelines.md). It is published under the [Apache License 2.0](https://github.com/Citi/citi-ospo/blob/main/LICENSE) and is copyright to Citi.

This document has been anotated as an educational tool and should be modified for use by your company under the guidance of the legal team.
...
<table>
  <tbody>
    <tr>
      ...
      <td>
        <p>
          These guidelines establish the minimum requirements and controls to be
          met by contributors to Free and Open Source Software ("FOSS")
          communities. The Company supports certain activities associated with
          the contribution and publication of FOSS, when doing so is a benefit
          to the Company and does not present unacceptable risk.
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <p>
          These guidelines apply to employees that wish to contribute to FOSS
          projects.
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <p>
          FOSS contributions range from fiat currency to technical currency.
          Examples include monetary donations or membership fees in return for
          an element of influence and employment of community members,
          coding/maintenance, documentation, testing, thought leadership, and
          management of approved FOSS efforts.
        </p>
      </td>
    </tr>
  </tbody>
...
To learn more about role of the OSPO please refer to:

- [Role of the OSPO](/docs/bok/Roles/OSPO)
- [Structure of the OSPO](/docs/bok/Artifacts/OSPO)
...
To learn more about potential risks please refer to:

- [Codebase Risk](/docs/bok/Risks/Codebase-Risk)
- [Data Leakage Risk](/docs/bok/Risks/Data-Leakage-Risk)
- [Dependency Risk](/docs/bok/Risks/Dependency-Risk)
- [Legal Risk](/docs/bok/Risks/Legal-Risk)
- [Operational Risk](/docs/bok/Risks/Operational-Risk)
- [Reputational Risk](/docs/bok/Risks/Reputational-Risk)
- [Staff Risk](/docs/bok/Risks/Staff-Risk)
- [Strategic Risk](/docs/bok/Risks/Strategic-Risk)
...
3.  **Non-Compliance with relevant Company Polices** - These are discussed in [Specific Alignment with Relevant Regulations](#specific-alignment-with-relevant-regulations) and include regulatory commitments such as Export and Trade Controls, and Cross Border Data Flows.

:::info

To learn more, please refer to:

- [Licenses](/docs/bok/Artifacts/Licenses)
- [Regulations](/docs/bok/Regulations/Introduction)
...
1.  Preventative and detective internal controls must be implemented to address the risks described in [FOSS Contribution Risk](#foss-contribution-risk).
...
3.  These guidelines impose no tooling restrictions when making contributions outside the Company's network on non-Company managed hardware other than defined in [Company Infrastructure](#company-infrastructure).
4.  These guidelines imposes no tooling restrictions for Personal contributions other than defined in [Company Infrastructure](#company-infrastructure).
...
- [Contribution Compliance - Acceptable Tools](/docs/bok/Activities/Level-3/Contribution-Compliance#acceptable-tools)
- [Software Inventory - Tools](/docs/bok/activities/level-2/software-inventory#tools)
- [License Management](/docs/bok/Activities/Level-2/License-Management)
- [Surveillance](/docs/bok/Activities/Level-3/Surveillance)
- [Regulations - Communication](/docs/bok/Regulations/Communication)
...
- [Software Inventory](/docs/bok/Activities/Level-2/Software-Inventory)
...
- [Compliate OSS Usage](/docs/category/2-compliant-usage)
...
- [Personal GitHub / GitLab IDs](/docs/bok/activities/level-3/surveillance#1-firm-specific--personal-githubgitlab-ids)
...
- [Communications](/docs/bok/Regulations/Communication)

:::

#### Technology Export/Import Regulations

Open source development is a global activity that makes software publicly available across national boundaries. Some countries may require FOSS project contributions to satisfy their local export control regulations. This is described in more detail in [Technology Export Regulations Compliance](#technology-export-regulations-compliance).

:::info

To learn more, please refer to:

- [Export Controls](/docs/bok/Regulations/Export)
- [Sanctions and Export Restriction](/docs/bok/Regulations/Sanctions)
...
2.  Contributions containing material non-public information, non-standard cryptography (as defined in [Technology Export Regulations Compliance](#technology-export-regulations-compliance)), or non-standard authentication mechanisms must be remediated (e.g., have sensitive information removed) before approval.

:::info

To learn more, please refer to:

- [Information Classification](/docs/bok/artifacts/ip#information-classification)
- [Personal Information](/docs/bok/Regulations/PI)
...
- [Cross-Border Oblications](/docs/bok/Regulations/Cross-Border)
...
- [Operations - Electronic Communications](/docs/operations/electronic-communications)
...
3.  Review and approval or rejection of licenses for contribution activities must address the risks described in [FOSS Contribution Risk](#foss-contribution-risk).
...
- [CLAs and DCOs](/docs/bok/artifacts/clas-and-dcos)
...
- [Open Source Program Office (OSPO)](/docs/bok/Artifacts/OSPO)
- [Creating an OSPO](/docs/bok/activities/level-2/creating-an-ospo)
...
- [Open Source Foundations](/docs/bok/Activities/Level-4/Foundations)
- [Open Source Project Incubation](/docs/bok/Activities/Level-4/Incubation)
...
- [Maintaining An Open Source Project](/docs/bok/Activities/Level-4/Maintaining-A-Project)
...
- [Open Sourcing a Project](/docs/bok/activities/level-4/open-sourcing-a-project)
...
1.  Company-Moderated, Company Interest projects which provide or perform non-standard [\[1\]](#footnotes) cryptography must be reviewed prior to OSPO approval (see [Technology Export/Import Regulations](#technology-export-regulations-compliance)).
...
1.  For all contribution activities which occur from within the Company network or on Company managed hardware, OSPO approved controls must be implemented to mitigate the risks described in [FOSS Contribution Risk](#foss-contribution-risk).
...
- [Activities - Contribution](/docs/bok/Activities/Introduction#level-3-contribution)

:::

#### Company Moderated Projects

1.  A FOSS Project team must be established consisting of the roles defined in [Roles & Responsibilities](#roles--responsibilities).
2.  The FOSS Project Team must define and document OSPO approved instructions describing how to report security vulnerabilities in the project [\[2\]](#footnote).
...
1.  A FOSS Project team must be established consisting of the applicable roles defined in [Roles & Responsibilities](#roles--responsibilities).
...
- [Open Source Consumption Training](/docs/bok/Activities/Level-2/Consumption-Training)
- [Open Source Contribution Training](/docs/bok/Activities/Level-3/Contribution-Training)
- [Training](/docs/bok/Training/Introduction)
...
- [Open Source Roles](/docs/bok/Roles/Introduction)
...
- [Roles - Legal](/docs/bok/Roles/Legal)
