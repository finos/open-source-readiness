...
- **[Licenses](../bok/Artifacts/Licenses)**: sometimes, OSPOs are started from a position of legal necessity.  Are you using code with appropriate licenses?  Does someone have to adjudicate which licenses are allowed and which aren't?  (See [License Compliance Management](../Level-2/License-Management)
