        ...
        <div className="mainContainer">
          ...
          <div className="wrapper">
            ...
            <ul>
              ...
              <li>
                <strong><a href="/docs/media/">Media</a></strong> from guest presentations and SIG sessions provides invaluable insights from experts and FSI colleagues on a range of topics related to open source usage, contribution, and compliance.
              </li>
              <li>
                We produce <strong><a href="/docs/resources/">resources</a></strong> to support FSI firms in developing robust open source programs, including an <a href="https://github.com/finos/OSLC-handbook">Open Source License Compliance Handbook</a> with information about complying with common open source licenses, a <a href="https://www.finos.org/business-value-of-open-source-for-financial-services-firms-download-page?hsLang=en-us">executive whitepaper on the business value of open source</a>, and a <a href="https://github.com/finos/reference-foss-policy">reference open source policy</a> for FSI firms. 
              </li>
            </ul>
          </div>
          ...
          <div className="wrapper">
            ...
            <ul>
              ...
              <li>
                Check out our <strong><a href="/docs/projects/">open source projects</a></strong>. All of our resources are collaboratively produced as open source projects, and we're always on the lookout for ways to enable participants to share knowledge and best practices in a form that's useful to their peers. If you have a project to propose, <a href="https://github.com/finos/open-source-readiness/issues">open a GitHub issue</a> and share your vision!
              </li>
            </ul>
          </div>
        </div>
