...
export default function Hello() {
	return (
		<Layout title="Hello" wrapperClassName="page-container">
			<img src="/img/bok/page-types/training.jpg" alt="Classroom scene" className="page-header-image" />
			...
			Here are some main jumping-off articles tagged with training.
			
			<BokTagList tag="Training" />
		</Layout>
	);
}
